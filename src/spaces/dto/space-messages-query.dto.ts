...
/**
 * Simple keyset pagination over space_messages' own BIGINT identity id —
 * same convention as chats/dto/messages-query.dto.ts (copied verbatim,
 * see that file's own doc comment for why the opaque base64 cursor from
 * workout-posts' pagination.util isn't used here either).
 */
export class SpaceMessagesQueryDto {
  @ApiPropertyOptional({
    description:
